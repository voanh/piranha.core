...
piranha.media = new function() {
    ...
    self.show = function (e) {
        $('.panel-media').addClass('active');
    };

    self.hide = function (e) {
        $('.panel-media').removeClass('active');
    };

    self.load = function (e, folderId) {
        $.ajax({
            url: piranha.baseUrl + 'manager/media/panel/' + folderId + '?filter=' + self.mediaFilter,
            success: function (data) {
                $('.panel-media .panel-body').html(data);
...
$(document).on('click', '.btn-media-select', function (e) {
    ...
    piranha.media.load($(e.relatedTarget), '');
    piranha.media.show();
});
